  ...
  <head>
	...
	<script type="text/javascript" src="js/jquery-1.11.1.js"></script>
 	<script language="javascript" type="text/javascript">
           	...
           	function validateProductId(){
           		...
           		if(reg.test(productId)&&productId!=null){
           			$("#productIdDiv").text("✔").removeClass("error_msg");
           			return true;
           		}else{
           			$("#productIdDiv").text("13位数字组合").addClass("validate_msg_medium error_msg");
           			return false;
           		}
           	}
          ...
          fromFlag = false;
            ...
            function showResult() {
            	if(validateProductId()&validateProductName()&validateProductWeight()&validateProductArea()&validateProductBrand()
   ...
   <body>
        ...
        <div id="main">            
            ...
            <form action="product/saveProduct.do" method="post" class="main_form">
                    <div class="text_info clearfix"><span>产品编号：</span></div>
                    <div class="input_info">
                        <input type="text" name="product_id" id="product_id" onblur="validateProductId();"/>
                        <span class="required">*</span>
                        <div id="productIdDiv" class="validate_msg_long"></div>
                    </div>
                    <div class="text_info clearfix"><span>产品名称：</span></div>
                    <div class="input_info">
                        <input type="text" name="product_name" id="product_name" onblur="validateProductName();"/>
                        <span class="required">*</span>
                        <div id="productNameDiv" class="validate_msg_long"></div>
                    </div>
                    <div class="text_info clearfix"><span>重量：</span></div>
                    <div class="input_info">
                        <input type="text" name="product_weight" id="product_weight" onblur="validateProductWeight();"/>
                        <span class="required">*</span>
                        <div id="productWeightDiv" class="validate_msg_long"></div>
                    </div>
                    <div class="text_info clearfix"><span>产地：</span></div>
                    <div class="input_info">
                        <input type=text name="product_area" id="product_area" onblur="validateProductArea();"/>
                        <span class="required">*</span>
                        <div id="productAreaDiv" class="validate_msg_long "></div>
                    </div>      
                    <div class="text_info clearfix"><span>品牌：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="product_brand" id="product_brand" onblur="validateProductBrand();"/>
                        <span class="required">*</span>
                        <div id="productBrandDiv" class="validate_msg_medium "></div>
                    </div>
                    <div class="text_info clearfix"><span>安全信息：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="safety_index" id="safety_index" onblur="validateSafety()"/>
                        <span class="required">*</span>
                        <div id="safetyDiv" class="validate_msg_medium "></div>
                    </div>
                     <div class="text_info clearfix"><span>保质期：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="expireDate" id="expireDate" onblur="validateExpireDate()"/>
                        <span class="required">*</span>
                        <div id="expireDateDiv" class="validate_msg_medium "></div>
                    </div>
                     <div class="text_info clearfix"><span>能量：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="energy" id="energy" onblur="validateEnergy()"/>
                        <span class="required">*</span>
                        <div id="energyDiv" class="validate_msg_medium "></div>
                    </div>
                     <div class="text_info clearfix"><span>蛋白质：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="protein" id="protein" onblur="validateProtein()"/>
                        <span class="required">*</span>
                        <div id="proteinDiv" class="validate_msg_medium "></div>
                    </div>
                     <div class="text_info clearfix"><span>脂肪：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="fat" id="fat" onblur="validateFat()"/>
                        <span class="required">*</span>
                        <div id="fatDiv" class="validate_msg_medium "></div>
                    </div>
                     <div class="text_info clearfix"><span>碳水化合物：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="carbohydrate" id="carbohydrate" onblur="validateCarbohydrate()"/>
                        <span class="required">*</span>
                        <div id="carbohydrateDiv" class="validate_msg_medium "></div>
                    </div>
                     <div class="text_info clearfix"><span>钠含量：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" name="sodium" id="sodium" onblur="validateSodium()"/>
                        <span class="required">*</span>
