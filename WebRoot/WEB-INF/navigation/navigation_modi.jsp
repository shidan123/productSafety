...
<html>
  <head>
	...
	<script language="javascript" type="text/javascript">
           	...
           	function validateNetAddress(){
                ...
                //保存成功的提示消息
            function showResult() {
            	if(validateLogoName()&validateNetAddress()){
            		return true;
            	}
            	return false;
            }
  ...
  <body>
        ...
        <div id="main">            
            ...
            <form action="navigation/update.do" method="post" class="main_form">
                   <div class="text_info clearfix"><span>ID：</span></div>
                    <div class="input_info">
                        <input type="text" name="id" readonly="readonly" id="id" value="${navigation.id }"onblur="validateId();"/>
                        <span class="required">*</span>
                        <div id="idDiv" class="validate_msg_long"></div>
                    </div>
                    <div class="text_info clearfix"><span>名称：</span></div>
                    <div class="input_info">
                        <input type="text" name="logoName" id="logoName" value="${navigation.logoName}" onblur="validateLogoName();"/>
                        <span class="required">*</span>
                        <div id="logoNameDiv" class="validate_msg_long"></div>
                    </div>
                    <div class="text_info clearfix"><span>网址：</span></div>
                    <div class="input_info">
                        <input type="text" name="netAddress" id="netAddress" value="${navigation.netAddress }" onblur="validateNetAddress();"/>
                        <span class="required">*</span>
